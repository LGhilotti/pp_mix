...
int main() {
    ...
    MatrixXd datacsv = load_csv<MatrixXd>("/home/lorenzo/Documents/Tesi/github_repos/pp_mix/data/data_autodiff_analytic/p_200_n_150.csv");
    ...
    duration<double, std::milli> ms_double = (t2 - t1)/niter;


    std::cout<<"ms per iter: "<<ms_double.count()<<std::endl;
    return 0;
