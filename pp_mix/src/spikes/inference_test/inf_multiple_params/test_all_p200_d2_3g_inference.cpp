...
int main() {
  ...
  cluster_alloc.tail(40) = VectorXi::Constant(40, 2);
    ...
    std::vector<double> prop_lambda_sigmas{0.01,0.1};
...
*/
    ...
    */
    ...
    myfile.open("./src/spikes/inference_test/inf_multiple_params/test_all_p200_d2_3g_inf.txt", std::ios::app);
/*
...
*/
    ...
    myfile << "Proposal lambda sigma: "<<prop_l_sigma<<"\n";
    myfile << "#### Means Acceptance rate: "<<sampler.a_means_acceptance_rate()<<"\n";
    myfile << "#### Lambda Acceptance rate: "<<sampler.Lambda_acceptance_rate()<<"\n";
